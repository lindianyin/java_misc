 ...
 * 
 */
package com.nfl.kfb.maintenance.dao;
 ...
 *
 */
public class MaintenanceSqlSession {
	
	private static final Logger logger = LoggerFactory.getLogger(MaintenanceSqlSession.class);
