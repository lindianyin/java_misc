...
public class TcpClient extends IoHandlerAdapter {
    ...
    public TcpClient() {
        ...
        //session.getFilterChain().addLast("protocol", new ProtocolCodecFilter(prefixedStringCodecFactory));
        session.getFilterChain().addLast("protocol", new ProtocolCodecFilter(new PackProtocolCodecFactory()));
    }
